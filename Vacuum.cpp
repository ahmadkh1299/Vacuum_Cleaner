...
Vacuum::Vacuum(House  h, int max_battery, int max_mission, std::pair<int, int>  dock,
    ...
    : house(std::move(h)), max_battery_vacuum(max_battery), max_mission_vacuum(max_mission),
      docking_station(std::move(dock)), curr_location(std::move(location)), curr_battery_level(battery_level),
